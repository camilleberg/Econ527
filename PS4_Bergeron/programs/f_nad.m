function net_assets = f_nad(z_grid, z_prob, u_fxn, u_prime_inv, u_prime, Params, a_grid, a_fine_grid)
...
%                = 0 at a general equilibrium interest rate
    ...
    [~, ~, ~, net_assets] = f_spe(z_grid, z_prob, u_fxn, u_prime_inv, u_prime, Params, a_grid, a_fine_grid);
end