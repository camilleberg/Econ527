...
\includegraphics [width=4in]{PS1_Q1_01.eps}
...
\includegraphics [width=4in]{PS1_Q1_02.eps}
...
\includegraphics [width=4in]{PS1_Q1_03.eps}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Unrecognized function or variable 'actual_acov2'.

Error in PS1_Q1 (line 99)
vars_actual = [actual_acf, actual_var, actual_acov1, actual_acov2, actual_cond_var];
                                                     ^^^^^^^^^^^^\end{verbatim} \color{black}
